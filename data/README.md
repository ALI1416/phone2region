...
- 文件名：`phone2region.zdb`
  ...
  - 链接地址：`https://www.404z.cn/files/phone2region/v2.4.0/data/phone2region.zdb`
  - 原始地址：`https://github.com/ALI1416/phone2region/blob/v2.4.0/data/phone2region.zdb`
- 文件名：`phone2region.txt`
  - 点击下载：[![phone2region.txt](https://img.shields.io/github/size/ALI1416/phone2region/data/phone2region.txt?label=phone2region.txt&color=success&branch=v2.4.0)](https://www.404z.cn/files/phone2region/v2.4.0/data/phone2region.txt)
  - 链接地址：`https://www.404z.cn/files/phone2region/v2.4.0/data/phone2region.txt`
  - 原始地址：`https://github.com/ALI1416/phone2region/blob/v2.4.0/data/phone2region.txt`
- 文件名：`phone.dat`(源文件有错误，错误记录`内蒙古|锡林郭勒|152500|00479`已更改为`内蒙古|锡林郭勒|26000|0479`，去除无效记录`9999999|作者|pangongzi|99999|999|未知`)
  - 点击下载：[![phone.dat](https://img.shields.io/github/size/ALI1416/phone2region/data/phone.dat?label=phone.dat&color=success&branch=v2.4.0)](https://www.404z.cn/files/phone2region/v2.4.0/data/phone.dat)
  - 链接地址：`https://www.404z.cn/files/phone2region/v2.4.0/data/phone.dat`
  - 原始地址：`https://github.com/ALI1416/phone2region/blob/v2.4.0/data/phone.dat`
- 文件名：`phone.old.dat`(数据来源<https://github.com/pangongzi/phone>，更新时间`2025年2月`)
  - 点击下载：[![phone.dat](https://img.shields.io/github/size/ALI1416/phone2region/data/phone.old.dat?label=phone.old.dat&color=success&branch=v2.4.0)](https://www.404z.cn/files/phone2region/v2.4.0/data/phone.old.dat)
  - 链接地址：`https://www.404z.cn/files/phone2region/v2.4.0/data/phone.old.dat`
  - 原始地址：`https://github.com/ALI1416/phone2region/blob/v2.4.0/data/phone.old.dat`
...
- 文件名：`phone.old.dat`(向原作者索要的最新版文件，更新时间`2024年5月`)
